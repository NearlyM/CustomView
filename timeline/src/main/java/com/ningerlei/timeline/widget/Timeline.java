package com.ningerlei.timeline.widget;//package com.ningerlei.custom.widget;
//
...
//
//        orientationMode = typedArray.getInt(0, R.styleable.Timeline_orientation) == 0 ? OrientationMode.HORIZONTAL : OrientationMode.VERTICAL;
